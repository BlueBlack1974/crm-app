...
-- =====================================================
-- Kullanıcılar Arası Mesajlaşma Tablosu - MSSQL (SQL Server)
-- =====================================================
-- Bu script SQL Server veritabanı için KullaniciMesajlari tablosunu oluşturur
-- SQL Server 2012+ ile uyumludur
...
BEGIN
    ...
    EXEC sys.sp_addextendedproperty 
        ...
        @level0type = N'SCHEMA', @level0name = N'dbo', 
        @level1type = N'TABLE', @level1name = N'KullaniciMesajlari';
    
    PRINT 'KullaniciMesajlari tablosu başarıyla oluşturuldu.';
END
ELSE
BEGIN
...
PRINT 'KullaniciMesajlari migration tamamlandı!';
GO
